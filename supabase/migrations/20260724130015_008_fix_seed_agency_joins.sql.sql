/*
# 008 — Fix seed data: agency joins and downstream re-seed

## Problem
Migration 007 mis-joined agencies for vehicles and drivers, leaving most downstream
tables empty. This migration deletes the bad demo rows and re-inserts them with
correct agency mapping.
